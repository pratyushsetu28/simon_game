...
def main():
    ...
    pygame.mixer.music.load('early-sunrise.ogg')
    ...
    while True: # main game loop
        ...
        # getting high score and updating in a file
        get_high_score()
        highscoreSurf = BASICFONT.render('High_Score: ' + str(HIGHSCORE), 1 , WHITE)
        highscoreRect = highscoreSurf.get_rect()
        highscoreRect.topleft = (5, 10)
...
def changeBackgroundAnimation(animationSpeed=40):
    global bgColor
    newBgColor = (random.randint(0, 150), random.randint(0, 150), random.randint(0, 150))
